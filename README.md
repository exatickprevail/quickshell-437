...
```bash
git clone https://github.com/exatickprevail/quickshell-437.git
cd quickshell-437
python setup.py
```
...
https://github.com/exatickprevail/quickshell-437/a5bf641b-ccff-41bd-a14c-619ed5c3321a
...
<!-- Last updated: 2026-06-06 19:42:43 -->
